                                ...
                                <form id="edit-form" method="POST" action="edit_order.php">
                                    <?php foreach($order as $r){ ?>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                <div class="order-detail">
                                                    <div class="order-detail-title">Address</div>
                                                    <div class="order-detail-value"><?php echo $r['user_address']; ?></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="order-detail">
                                                    <div class="order-detail-title">Phone</div>
                                                    <div class="order-detail-value"><?php echo $r['user_phone']; ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-grid mt-4">
                                            <button type="submit" class="btn buy-btn" name="edit_order"> Update Order Status
                                            </button>
                                        </div>
                                    <?php } ?>
                                </form>
