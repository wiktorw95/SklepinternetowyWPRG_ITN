            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tr>
                        ...
                        <td class="<?php echo $order['order_status'] == 'On Hold' ? 'bg-warning' :
                            ($order['order_status'] == 'Delivered' ? 'bg-success' : ($order['order_status'] == 'Not Paid' ?  'bg-danger' : ($order['order_status'] == 'Shipped' ?  'bg-primary' :'bg-info'))); ?>"><?php echo $order['order_status']?></td>
